A区间的最大公约数等于B区间最小值，那么整个数组的最小值一定不会在A区间，以最小值做为
最大公约数，遍历其他元素，如果能整除说明是最小值的倍数，放在A区间中，最终判断A区间的gcd是否等于这个最小值
...
public class Main {
    ...
    void solve(){
        ...
        if(g == arr[0]) System.out.println("YES");
