重点在于公式的推断[C题题解](https://blog.nowcoder.net/n/1efde45f5751421c9ebe2118b0ffd125)
...
public class Main {
    ...
    void solve(){
        ...
        if(v > Math.sqrt(x*y)) System.out.printf("%.12f",y/v);
        else System.out.printf("%.12f",2*Math.sqrt(y/x) - v/x);        
    }
